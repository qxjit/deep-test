...
unit_tests do
  ...
  test "count returns nil on other platforms" do
    assert_equal nil, DeepTest::CpuInfo.new("foobar").count
  end

  test "platform defaults to the current ruby_platform" do
    assert_equal RUBY_PLATFORM, DeepTest::CpuInfo.new.platform
  end
end
