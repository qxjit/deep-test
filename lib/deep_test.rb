...
require File.dirname(__FILE__) + "/deep_test/distributed/master_mirror_server"
require File.dirname(__FILE__) + "/deep_test/distributed/mirror_server"
require File.dirname(__FILE__) + "/deep_test/distributed/mirror_server_status"
require File.dirname(__FILE__) + "/deep_test/distributed/mirror_server_workers"
require File.dirname(__FILE__) + "/deep_test/distributed/multi_mirror_server_proxy"
